...
public class TemplePriest implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.templepriest", "Temple Priest", "A priest of the Drowning Temple.", "model.creature.humanoid.jackal.rift.summoner", types, (byte) 0, (short) 8, (byte) 10, (short) 200, (short) 45,
                (short) 30, "sound.death.troll", "sound.death.troll", "sound.combat.hit.troll", "sound.combat.hit.troll", 0.2f, 10.0f, 7.0f, 9.0f, 0.0f, 0.0f, 1.4f, 700, butcheredItems, 10, 94);
