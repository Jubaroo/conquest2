...
public class Fleshwalker implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.fleshwalker", "Fleshwalker", "A collection of flesh and bones of forgotten soldiers returned into life", "model.creature.humanoid.human.player.zombie", types, (byte) 0, (short) 8, (byte) 10, (short) 200, (short) 45,
                (short) 30, "sound.combat.death.zombie", "sound.combat.death.zombie", "sound.combat.hit.zombie", "sound.combat.hit.zombie", 1.0f, 5.0f, 3.0f, 7.0f, 0.0f, 0.0f, 1.0f, 200, butcheredItems, 10, 94);
