...
public class GoblinWarlord implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.goblinwarlord", "Goblin Warlord", "A particularly intimidating goblin.", "model.creature.humanoid.goblin.leader", types, (byte) 0, (short) 8, (byte) 10, (short) 200, (short) 45,
                (short) 30, "sound.death.male", "sound.death.female", "sound.combat.hit.male", "sound.combat.hit.female", 0.4f, 7.0f, 4.0f, 8.0f, 0.0f, 0.0f, 1.5f, 1200, butcheredItems, 10, 94);
