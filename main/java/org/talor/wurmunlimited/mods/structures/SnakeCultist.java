...
public class SnakeCultist implements ModCreature, CreatureTypes {

    public int templateId;

    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        int[] types = {C_TYPE_AGG_HUMAN, C_TYPE_MOVE_LOCAL, C_TYPE_CARNIVORE, C_TYPE_CLIMBER};
        int[] butcheredItems = new int[]{636, 92};

        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.snakecultist", "Snake Cultist", "An acolyte of the snake gods.", "model.creature.humanoid.human.salesman", types, (byte) 0, (short) 8, (byte) 10, (short) 200, (short) 45,
        ...
        Structures.snakeCultistID = templateId;
