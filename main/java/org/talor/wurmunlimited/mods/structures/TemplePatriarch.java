...
public class TemplePatriarch implements ModCreature, CreatureTypes {
    ...
    public CreatureTemplateBuilder createCreateTemplateBuilder() {
        ...
        CreatureTemplateBuilder builder = new CreatureTemplateBuilder("mod.creature.templepatriarch", "Temple Patriarch", "A ruler of the Drowning Temple", "model.creature.humanoid.warmaster.rift", types, (byte) 0, (short) 8, (byte) 10, (short) 200, (short) 45,
                (short) 30, "sound.death.troll", "sound.death.troll", "sound.combat.hit.troll", "sound.combat.hit.troll", 0.03f, 15.0f, 12.0f, 15.0f, 0.0f, 0.0f, 1.6f, 700, butcheredItems, 10, 94);
